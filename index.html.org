    ...
    <section class="hero is-info is-medium is-bold">
      <div class="hero-body">
        <div class="container has-text-centered">
          ...
          <a class="github-button" href="https://github.com/dansup/bulma-templates" data-size="large" aria-label="View dansup/bulma-templates on GitHub">View on Github</a>
          <a class="github-button" href="https://github.com/dansup/bulma-templates" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star dansup/bulma-templates on GitHub">Star</a>
          <a class="github-button" href="https://github.com/dansup/bulma-templates/fork" data-size="large" data-show-count="true" aria-label="Fork dansup/bulma-templates on GitHub">Fork</a>
        </div>
      </div>
    </section>
        ...
        <div class="column is-4">
          ...
          <div class="card">
            <header class="card-header">
              <p class="card-header-title">
                ...
                <span class="is-pulled-right">
                  <a href="https://github.com/jgthms/bulma/releases/tag/0.7.1">
                    <span class="tag is-default">v0.7.1</span>
                  </a>
            ...
            <footer class="card-footer">
              ...
              <a href="https://github.com/dansup/bulma-templates/blob/master/templates/admin.html" class="card-footer-item">Source Code</a>
            </footer>
          </div>
          <!-- cards -->
          <div class="card">
            ...
            <footer class="card-footer">
              ...
              <a href="https://github.com/dansup/bulma-templates/blob/master/templates/cards.html" class="card-footer-item">Source Code</a>
            </footer>
          </div>
          <!-- forum -->
          <div class="card">
          ...
          <div class="card">
            ...
            <footer class="card-footer">
              ...
              <a href="https://github.com/dansup/bulma-templates/blob/master/templates/instaAlbum.html" class="card-footer-item">Source Code</a>
            </footer>
          </div>
          <!-- landing -->
          <div class="card">
            ...
            <footer class="card-footer">
              ...
              <a href="https://github.com/dansup/bulma-templates/blob/master/templates/landing.html" class="card-footer-item">Source Code</a>
            </footer>
          </div>
          <!--tabs-->
          <div class="card">
            ...
            <div class="card-content">
              <figure class="image">
                <img src="images/tabs.png" alt="tabs template screenshot">
              </figure>
            </div>
            <footer class="card-footer">
              <a href="templates/tabs.html" class="card-footer-item">Preview</a>
              <a href="https://github.com/dansup/bulma-templates/blob/master/templates/tabs.html" class="card-footer-item">Source Code</a>
            </footer>
          </div>
        </div>
        <div class="column is-4">
          ...
          <div class="card">
            ...
            <footer class="card-footer">
              ...
              <a href="https://github.com/dansup/bulma-templates/blob/master/templates/band.html" class="card-footer-item">Source Code</a>
            </footer>
          </div>
          <!-- cheatsheet -->
          <div class="card">
            ...
            <footer class="card-footer">
              ...
              <a href="https://github.com/dansup/bulma-templates/blob/master/templates/cheatsheet.html" class="card-footer-item">Source Code</a>
            </footer>
          </div>
          <!-- hero -->
          <div class="card">
            ...
            <footer class="card-footer">
              ...
              <a href="https://github.com/dansup/bulma-templates/blob/master/templates/hero.html" class="card-footer-item">Source Code</a>
            </footer>
          </div>
          <!--kanban -->
          <div class="card">
            ...
            <footer class="card-footer">
              ...
              <a href="https://github.com/dansup/bulma-templates/blob/master/templates/kanban.html" class="card-footer-item">Source Code</a>
            </footer>
          </div>
          <!-- login -->
          <div class="card">
            ...
            <footer class="card-footer">
              ...
              <a href="https://github.com/dansup/bulma-templates/blob/master/templates/login.html" class="card-footer-item">Source Code</a>
            </footer>
          </div>
        </div>
        <div class="column is-4">
          ...
          <div class="card">
            ...
            <footer class="card-footer">
              ...
              <a href="https://github.com/dansup/bulma-templates/blob/master/templates/cover.html" class="card-footer-item">Source Code</a>
            </footer>
          </div>
          <!--inbox -->
          <div class="card">
          ...
          <div class="card">
            <header class="card-header">
              <p class="card-header-title">
                <span>Kanban  with functional Search box</span>
                <span class="is-pulled-right">
                  <a href="https://github.com/jgthms/bulma/releases/tag/0.7.1">
                    <span class="tag is-default">v0.7.1</span>
                  </a>
            ...
            <footer class="card-footer">
              ...
              <a href="https://github.com/dansup/bulma-templates/blob/master/templates/kanban[search].html" class="card-footer-item">Source Code</a>
            </footer>
          </div>
          <!--tabs-->
          <div class="card">
            ...
            <footer class="card-footer">
              ...
              <a href="https://github.com/dansup/bulma-templates/blob/master/templates/modal-cards.html" class="card-footer-item">Source Code</a>
            </footer>
          </div>
          <div class="box">
